package gameproject;
	...
	public class WheelClass {
	    ...
	    WheelClass() {
	        ...
	        easyWheel.add("Tell me the most luxurious thing youâ€™ll get when youâ€™re rich.");
	        ...
	        easyWheel.add("Make your choice ! KÃ¼nefe or Baklava.");
	        ...
	        hardWheel.add("Who is director of the â€œTenetâ€� ? ");//14
	        ...
	        braveWheel.add("Say the most ridiculous thing youâ€™ve ever memorized.");
